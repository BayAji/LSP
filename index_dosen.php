...
<body>
    ...
    <header class="navbar d-flex justify-content-center py-3" style="background-color: #e3f2fd">
        <ul class=" nav nav-pills">
            ...
            <li class="nav-item"><a href="index_dosen.php" class="nav-link active" aria-current="page">Dosen</a></li>
    ...
    <div class="container">
        <br>
        <a class="btn btn-primary" href="tambah_dosen.php">[+] Tambah Dosen</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($dosen = mysqli_fetch_array($query)) {
                            ...
                            echo "<td>" . $dosen['kelamin'] . "</td>";
                            echo "<td>" . $dosen['prodi'] . "</td>";
                            echo "<td>" . $dosen['fakultas'] . "</td>";


                            echo "<td>";
                            echo "<a class='btn btn-danger' href='hapus_dosen.php?id=" . $dosen['id'] . "'>Hapus</a>";
                            echo "</td>";
