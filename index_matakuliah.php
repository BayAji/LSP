...
<body>
    ...
    <header class="navbar d-flex justify-content-center py-3" style="background-color: #e3f2fd">
        <ul class=" nav nav-pills">
            ...
            <li class="nav-item"><a href="index_matakuliah.php" class="nav-link active" aria-current="page">Mata Kuliah</a></li>
    ...
    <div class="container">
        <br>
        <a class="btn btn-primary" href="tambah_matakuliah.php">[+] Tambah Mata Kuliah</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($matakuliah = mysqli_fetch_array($query)) {
                            ...
                            echo "<td>" . $matakuliah['id'] . "</td>";
                            echo "<td>" . $matakuliah['nama'] . "</td>";
                            echo "<td>" . $matakuliah['sks'] . "</td>";
                            echo "<td>" . $matakuliah['id_dosen'] . "</td>";

                            echo "<td>";
                            echo "<a class='btn btn-danger'href='hapus_matakuliah.php?id=" . $matakuliah['id'] . "'>Hapus</a>";
                            echo "</td>";
